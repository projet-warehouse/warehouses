    ...
    <section class="account">
        ...
        <div class="account__card border-bottom-0 border-left-0 border-top-0 border-right-0 h-100">
            <div class="account__card--header">
                <h3 class="account__card--title"> Votre liste d'envies (3)</h3>
            </div>

            <div class="card mt-3 mb-3 mx-4 p-3 d-flex" style="">
                <div class="row no-gutters">
                    <div class="col-md-3">
                        <img src="{{ asset('images/reveil.jpg') }}" class="card-img" alt="..."
                            style="max-width:150px">
                    </div>
                    <div class="col-md-6">
                        <div class="card-body">
                            <p class="card-title">
                                Chaud Nouveau Réveil Rétro-éclairage Grand Affichage
                                électronique LCD Réveil Numérique--Blanc
                            </p>
                            <p class="card-text">
                                <small class="text-dark h6 ">13,900 FCFA</small>
                            </p>
                            <p class="card-text d-flex">
                                <small class="text-muted h6 text-line-through">35,000 FCFA</small>
                                <span class="reduction h6 mx-2">-60%</span>
                            </p>
                        </div>
                    </div>
                    <div class="col-md-3 align-items-md-end d-flex flex-column justify-content-center">
                        <button type="button" class="btn btn-color1">ACHETER</button>
                        <button type="button" class="btn btn-color2">SUPPRIMER</button>
                    </div>
                </div>
            </div>
