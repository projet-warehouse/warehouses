...
<div class="main-wrapper">
  ...
  @include('admin/partials/navbar')
	...
	<div class="page-content">
        ...
        <div class="card p-4">
          {{-- <form method='POST' action='{{ route('update.souscategory', $cat_mod->id) }}'> --}}
            @csrf
            ...
            <div class="form-group">
              <label>Selectionner la Cathégorie</label>
              <select name="categorie" class="form-control">
                {{-- @foreach ($cat_select as $list)
            ...
            {{-- <a href="{{ route('souscategory') }}" class="btn btn-primary">Annuler</a> --}}
          {{-- </form> --}}
        </div>
        {{-- <div>
