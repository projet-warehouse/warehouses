        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#advancedUI" role="button" aria-expanded="false" aria-controls="advancedUI">
              ...
              <span class="link-title">Gestion category</span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="advancedUI">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ url('admin/categories') }}" class="nav-link">Nos catégories</a>
                </li>
          ...
          <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#forms" role="button" aria-expanded="false" aria-controls="forms">
              ...
              <span class="link-title"> Gestions produits </span>
              <i class="link-arrow" data-feather="chevron-down"></i>
            </a>
            <div class="collapse" id="forms">
              <ul class="nav sub-menu">
                <li class="nav-item">
                  <a href="{{ route('manage-products') }}" class="nav-link">Nos Produits</a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('add-products') }}" class="nav-link">New Product</a>
                </li>
